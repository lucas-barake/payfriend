...
import ArchiveDialog from "$/pages/dashboard/(page-lib)/components/debt-card/lender-actions-menu/archive-dialog";
import BorrowersDialog from "$/pages/dashboard/(page-lib)/components/debt-card/lender-actions-menu/borrowers-dialog";
import { type DebtsAsLenderInput } from "$/server/api/routers/debts/queries/handlers/debts-as-lender/input";
import PaymentsDialog from "$/pages/dashboard/(page-lib)/components/debt-card/lender-actions-menu/payments-dialog";
