...
import { createDebtInput } from "$/server/api/routers/groups/debts/mutations/input";
import CUSTOM_EXCEPTIONS from "$/server/api/custom-exceptions";

export const groupDebtsMutations = createTRPCRouter({
  createDebt: protectedVerifiedProcedure
